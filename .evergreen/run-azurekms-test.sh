...
SKIP_SERVERS=1 just setup-encryption
...
AZUREKMS_CMD="pip install -e \".[test]\" && KEY_NAME=\"$AZUREKMS_KEYNAME\" KEY_VAULT_ENDPOINT=\"$AZUREKMS_KEYVAULTENDPOINT\" SUCCESS=true TEST_FLE_AZURE_AUTO=1 ./.evergreen/run-tests.sh" \
    $DRIVERS_TOOLS/.evergreen/csfle/azurekms/run-command.sh
