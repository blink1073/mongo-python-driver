...
-   We use [hatch](https://hatch.pypa.io/dev/) for our Python environment management and packaging tool.
...
-   Install [just](https://just.systems/man/en/packages.html) (e.g. `brew install just`)
-   Run `pip install hatch` to use `hatch` for isolated testing or run
